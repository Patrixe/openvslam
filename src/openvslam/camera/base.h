...
namespace openvslam {
    ...
    namespace camera {
        ...
        public:
            ...
            virtual void undistort_keypoints(data::keypoint_container &dist_keypts,
                                             openvslam::data::keypoint_container &undist_keypts) const = 0;
            ...
            virtual void convert_keypoints_to_bearings(data::keypoint_container &undist_keypts) const = 0;
            ...
            virtual bool reproject_to_image(const Mat33_t &rot_cw, const Vec3_t &trans_cw, const Vec3_t &pos_w,
                                            Vec2_t &reproj, float &x_right) const = 0;
