...
public:
    ...
    unsigned int match_frame_and_keyframe(data::keyframe* keyfrm, data::frame& frm, std::map<int, data::landmark*>& matched_lms_in_frm) const;
    ...
    unsigned int match_keyframes(data::keyframe* keyfrm_1, data::keyframe* keyfrm_2, std::map<int, data::landmark*>& matched_lms_in_keyfrm_1) const;
};
