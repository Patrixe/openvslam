...
#include "segmentation_frame_publisher.h"

#include "openvslam/data/landmark.h"
#include "openvslam/data/map_database.h"
#include "openvslam/segmentation/segmentation_tracking_module.h"
...
namespace openvslam {
    namespace publish {
        ...
        segmentation_frame_publisher::segmentation_frame_publisher(const std::shared_ptr<config>& cfg, data::map_database* map_db,
        ...
        cv::Mat segmentation_frame_publisher::draw_frame(const bool draw_text) {
            cv::Mat img;
        ...
        unsigned int segmentation_frame_publisher::draw_initial_points(cv::Mat& img, const std::vector<cv::KeyPoint>& init_keypts,
        ...
        unsigned int segmentation_frame_publisher::draw_tracked_points(cv::Mat& img, const std::vector<cv::KeyPoint>& curr_keypts,
        ...
        void segmentation_frame_publisher::draw_info_text(cv::Mat& img, const tracker_state_t tracking_state, const unsigned int num_tracked,
        ...
        void segmentation_frame_publisher::update(openvslam::segmentation::segmentation_tracking_module* tracker) {
            std::lock_guard<std::mutex> lock(mtx_);
