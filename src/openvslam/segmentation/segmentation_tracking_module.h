...
namespace openvslam {
    ...
    namespace openvslam {
        namespace segmentation {
            ...
            public:
                segmentation_tracking_module(std::__1::shared_ptr<config> cfg, system *system,
                                             data::map_database *map_db,
                                             data::bow_vocabulary *bow_vocab, data::bow_database *bow_db,
                                             const std::__1::shared_ptr<segmentation_config> &seg_cfg);
                ...
                void set_mapping_module_status(bool mapping_is_enabled);

                //! Get mapping module status
                bool get_mapping_module_status() const;

                //! Get the keypoints of the initial frame
                std::__1::vector<cv::KeyPoint> get_initial_keypoints() const;
            ...
            protected:
                ...
                optimize::segmentation_pose_optimizer segmentation_aware_pose_optimizer;

                //! config
                const std::__1::shared_ptr<config> cfg_;
                ...
                data::segmentation_frame curr_frm_;
                ...
                feature::segmented_orb_extractor *extractor_left_ = nullptr;
                //! ORB extractor for right image
                feature::segmented_orb_extractor *extractor_right_ = nullptr;
                //! ORB extractor only when used in initializing
                feature::segmented_orb_extractor *ini_extractor_left_ = nullptr;
            ...
            //! last frame
            data::segmentation_frame last_frm_;
