...
#include <openvslam/segmentation/optimize/segmentation_pose_optimizer.h>
...
namespace openvslam {
    openvslam::segmentation::segmentation_tracking_module::segmentation_tracking_module(const std::shared_ptr<config> cfg,
            ...
            : cfg_(cfg), camera_(cfg->camera_), system_(system), map_db_(map_db), bow_vocab_(bow_vocab), bow_db_(bow_db),
              ...
              keyfrm_inserter_(cfg_->camera_->setup_type_, cfg_->true_depth_thr_, map_db, bow_db, 0, cfg_->camera_->fps_), seg_cfg(seg_cfg), segmentation_aware_pose_optimizer() {
    ...
    Mat44_t openvslam::segmentation::segmentation_tracking_module::track_monocular_image_with_segmentation(const cv::Mat &img, const cv::Mat &seg_img,
    ...
    Mat44_t
    openvslam::segmentation::segmentation_tracking_module::track_stereo_image_with_segmentation(const cv::Mat &left_img_rect, const cv::Mat &right_img_rect,
...
//
//        // create current frame object
//        curr_frm_ = data::segmentation_frame(img_gray_, img_depth, timestamp, extractor_left_, bow_vocab_, camera_,
//                                cfg_->true_depth_thr_, mask);
//
//        track();
//
...
//    }
    ...
    bool openvslam::segmentation::segmentation_tracking_module::optimize_current_frame_with_local_map() {
    ...
    bool openvslam::segmentation::segmentation_tracking_module::track_current_frame() {
    ...
    bool openvslam::segmentation::segmentation_tracking_module::initialize() {
    ...
    void openvslam::segmentation::segmentation_tracking_module::insert_new_keyframe() {
    ...
    void openvslam::segmentation::segmentation_tracking_module::set_mapping_module(mapping_module* mapper) {
        mapper_ = mapper;
        keyfrm_inserter_.set_mapping_module(mapper);
    }

    void openvslam::segmentation::segmentation_tracking_module::set_global_optimization_module(global_optimization_module* global_optimizer) {
        global_optimizer_ = global_optimizer;
    }

    void openvslam::segmentation::segmentation_tracking_module::set_mapping_module_status(const bool mapping_is_enabled) {
        std::lock_guard<std::mutex> lock(mtx_mapping_);
        mapping_is_enabled_ = mapping_is_enabled;
    }

    bool openvslam::segmentation::segmentation_tracking_module::get_mapping_module_status() const {
        std::lock_guard<std::mutex> lock(mtx_mapping_);
        return mapping_is_enabled_;
    }

    std::vector<cv::KeyPoint> openvslam::segmentation::segmentation_tracking_module::get_initial_keypoints() const {
        return initializer_.get_initial_keypoints();
    }

    std::vector<int> openvslam::segmentation::segmentation_tracking_module::get_initial_matches() const {
        return initializer_.get_initial_matches();
    }

    void openvslam::segmentation::segmentation_tracking_module::reset() {
    ...
    void openvslam::segmentation::segmentation_tracking_module::track() {
    ...
    void openvslam::segmentation::segmentation_tracking_module::update_motion_model() {
    ...
    void openvslam::segmentation::segmentation_tracking_module::apply_landmark_replace() {
    ...
    void openvslam::segmentation::segmentation_tracking_module::update_last_frame() {
    ...
    void openvslam::segmentation::segmentation_tracking_module::update_local_map() {
    ...
    void openvslam::segmentation::segmentation_tracking_module::search_local_landmarks() {
    ...
    bool openvslam::segmentation::segmentation_tracking_module::new_keyframe_is_needed() const {
    ...
    void openvslam::segmentation::segmentation_tracking_module::request_pause() {
        std::lock_guard<std::mutex> lock1(mtx_pause_);
        pause_is_requested_ = true;
    }

    bool openvslam::segmentation::segmentation_tracking_module::pause_is_requested() const {
        std::lock_guard<std::mutex> lock(mtx_pause_);
        return pause_is_requested_;
    }

    bool openvslam::segmentation::segmentation_tracking_module::is_paused() const {
        std::lock_guard<std::mutex> lock(mtx_pause_);
        return is_paused_;
    }

    void openvslam::segmentation::segmentation_tracking_module::resume() {
        std::lock_guard<std::mutex> lock(mtx_pause_);
    ...
    bool openvslam::segmentation::segmentation_tracking_module::check_and_execute_pause() {
        std::lock_guard<std::mutex> lock(mtx_pause_);
    ...
    bool openvslam::segmentation::segmentation_tracking_module::is_tracking() {
        return tracking_state_ == tracker_state_t::Tracking;
    }

    openvslam::segmentation::segmentation_tracking_module::~segmentation_tracking_module() {
        ...
        spdlog::debug("DESTRUCT: segmentation_tracking_module");
    }
}