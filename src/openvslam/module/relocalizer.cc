    ...
    namespace module {
        ...
        bool relocalizer::relocalize(data::frame &curr_frm) {
            ...
            for (unsigned int i = 0; i < num_candidates; ++i) {
                ...
                const auto num_matches = bow_matcher_.match_frame_and_keyframe(keyfrm, curr_frm,
                                                                               matched_landmarks.at(i));
                ...
                auto num_found = proj_matcher_.match_frame_and_keyframe(curr_frm, reloc_candidates.at(i),
