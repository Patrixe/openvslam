...
public:
     ...
     */
    std::map<int, data::landmark*> current_matched_landmarks_observed_in_candidate() const;
     ...
     */
    std::map<int, data::landmark*> current_matched_landmarks_observed_in_candidate_covisibilities() const;
...
private:
    ...
    std::map<int, data::landmark*> curr_match_lms_observed_in_cand_;
    ...
    std::map<int, data::landmark*> curr_match_lms_observed_in_cand_covis_;
